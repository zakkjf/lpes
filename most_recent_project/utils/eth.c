...
//
//*****************************************************************************
int32_t ProcessReceivedPacket(uint8_t *pui8Buf)
{
                ...
                DES0_RX_STAT_ERR))
        {
                    ...
                    DES0_RX_STAT_LAST_DESC)
            {
                ...
                i32FrameLen =
					...
					//
                pui8Buf = g_psRxDescriptor[g_ui32RxDescIndex].pvBuffer1;
            }
        }
    }
	//
